        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Edit Bupati</h3>
                </div>
            </div>
            <div class="card-body">
                <?= form_open('/admin/jabatan-bupati/update', 'enctype="multipart/form-data"'); ?>
                    <!-- begin::id -->
                    <input 
                        type="hidden" 
                        name="jabatan_bupati_id"
                        value="<?= $jabatanbupati['jabatan_bupati_id'] ?>"
                    >
                    <!-- end::id -->
                    <!-- begin::old-foto -->
                    <input 
                        type="hidden" 
                        name="old_jabatan_bupati_foto"
                        value="<?= $jabatanbupati['jabatan_bupati_foto'] ?>"
                    >
                    <!-- end::old-foto -->
                    <!-- begin::nama-bupati -->
