        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Edit Sub Domain</h3>
                </div>
            </div>
            <div class="card-body">
                <?= form_open('/admin/subdomain/update'); ?>
                    <!-- begin::id-subdomain -->
                    <input type="hidden" name="sub_domain_id" value="<?= $subdomain['sub_domain_id'] ?>">
                    <!-- end::id-subdomain -->
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="<?= $subdomain['sub_domain_link'] ?>"
                            required
                        >
                    </div>
                    <!-- end::link-subdomain -->
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="<?= $subdomain['sub_domain_deskripsi'] ?>"
                            required
                        >
                    </div>
